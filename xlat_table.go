...
var xlatTable = []xlat_t{
	...
	{"NUMBER", num_t{scale: lowhigh_t{2, 9}, precision: lowhigh_t{0, 0}}, "int"},
	{"NUMBER", num_t{scale: lowhigh_t{10, 38}, precision: lowhigh_t{0, 0}}, "long"},
	{"NUMBER", num_t{scale: lowhigh_t{0, 38}, precision: lowhigh_t{10, 38}}, "decimal"},
	{"NUMBER", num_t{scale: lowhigh_t{0, 38}, precision: lowhigh_t{1, 9}}, "double"},
	...
	{"TIMESTAMP(4)", num_t{scale: lowhigh_t{0, 0}, precision: lowhigh_t{0, 0}}, "date"},
